...
public class WechatAppletReq extends WechatQrReq{
	//订单描述(必须)
    private String body = "";
    //商品详情
	 ...
	 * @param notifyUrl
	 */
	public WechatAppletReq(String appId,String merchId,String subMerchId,
			String subAppid,String outTradeNo,
	 ...
	 */
	public WechatAppletReq(String appId,String merchId,String subMerchId,String subAppid,
