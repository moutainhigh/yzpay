...
/**
 * 微信扫码支付请求类(用户扫商户)
 * 文件名称:     ScanCodePayReqData.java
 * 内容摘要: 
 * @author:   Zeng Dongcheng
 * @version:  1.0  
 * @Date:     2017年6月16日下午4:00:57 
 * 
 * 修改历史:  
 * 修改日期                     修改人员                                   版本	            修改内容  
 * ----------------------------------------------  
 ...
 * 公司:   深圳市至高通信技术发展有限公司
 */
public class WechatScanReq extends WechatQrReq{
	//订单描述(必须)
    private String body = "";
    //商品详情
	 ...
	 * @param notifyUrl
	 */
	public WechatScanReq(String appId,String merchId,String subMerchId,String outTradeNo,
	...
	public WechatScanReq(String appId,String merchId,String subMerchId,String outTradeNo,
			int totalFee, String body,String deviceInfo,String spBillCreateIP,
			String goodsTag,String attach,String notifyUrl,
			String timeStart,String timeExpire) {
		//微信分配的公众号ID（开通公众号之后可以获取到）
		setAppid(appId);
		//微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
		setMch_id(merchId);
