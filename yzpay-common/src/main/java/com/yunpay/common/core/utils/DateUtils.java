...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	public static final SimpleDateFormat NOW_DATE_FORMAT = new SimpleDateFormat("yyyy年MM月dd日");
	
	public static final SimpleDateFormat LONG_DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	
	public static final SimpleDateFormat DATE_FORMAT_YY = new SimpleDateFormat("yy-MM-dd HH:mm:ss");
	public static final SimpleDateFormat DATE_FORMAT_MM = new SimpleDateFormat("MM-dd HH:mm:ss");
	public static final SimpleDateFormat HMS_FORMAT = new SimpleDateFormat("HH:mm:ss");
	public static final SimpleDateFormat HMS_NOW = new SimpleDateFormat("HHmmss");
	public static final SimpleDateFormat DATE_FORMAT_YMDH = new SimpleDateFormat("yyyyMMddHH");
	public static final SimpleDateFormat formatTimestamp = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	public static final SimpleDateFormat formatDate = new SimpleDateFormat("yy-MM-dd HH:mm:ss");
	...
	public static String getNowDate(Date date) {
		return NOW_DATE_FORMAT.format(date);
	}
	...
	* @throws
	 */
	public static String getCalendarOfDate(int d){
	...
	public static String getNowTime(){
		return HMS_NOW.format(new Date());
	}
	
	/**
	 * 获取年月日时 2017091911格式的时间戳
	* 
	* @param 
	* @return String
	* @throws
	 */
	public static String getYMDHString (){
		return DATE_FORMAT_YMDH.format(new Date());
	}
	/**
	 * 得到时间戳格式字串
	 * 
	...
	public static String dateFormatYY(Date date) {
		return DATE_FORMAT_YY.format(date);
	}
	
	
	public static String dataFormatMM(Date date){
	 ...
	 * @return
	 */
	public static Integer getSecondDiff(Date date1, Date date2){
		if (date1 == null || date2 == null) {
			return 0;
		}
		Long diffl =(date1.getTime() - date2.getTime())/1000L;
		Integer diff= Integer.parseInt(diffl.toString());
		return diff;
	}
