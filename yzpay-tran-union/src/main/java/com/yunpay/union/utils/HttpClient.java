...
import com.yunpay.union.common.BaseHttpSSLSocketFactory;
import com.yunpay.union.common.BaseHttpSSLSocketFactory.TrustAnyHostnameVerifier;
...
public class HttpClient {
	...
	private String response(final HttpURLConnection connection, String encoding)
		...
		try {
			...
			Log.debug("HTTP Return Status-Code:["
