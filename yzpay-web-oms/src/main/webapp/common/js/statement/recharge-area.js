$(function(){    
	$("#recharge-area-today").click(function(){ 
		$.ajax({
			type:"post", 
	    	dataType: "text", 
		    url: rechargeAreaTodayurl, 
	...
	$("#recharge-area-yesterday").click(function(){ 
		$.ajax({
			type:"post", 
	    	dataType: "text", 
		    url: rechargeAreaYesterdayurl, 
		    contentType: "application/x-www-form-urlencoded; charset=utf-8",
		    success: function (result){ 
		    	var jsonobj = JSON.parse(result);
		    	var areaNameArray = new Array();
	...
	$("#recharge-area-week").click(function(){ 
		$.ajax({
			type:"post", 
	    	dataType: "text", 
		    url: rechargeAreaWeekurl, 
		    contentType: "application/x-www-form-urlencoded; charset=utf-8",
		    success: function (result){ 
		    	var jsonobj = JSON.parse(result);
		    	var areaNameArray = new Array();
	...
	$("#recharge-area-month").click(function(){    
		$.ajax({
			type:"post", 
	    	dataType: "text", 
		    url: rechargeAreaMonthurl, 
		    contentType: "application/x-www-form-urlencoded; charset=utf-8",
		    success: function (result){  
		    	var jsonobj = JSON.parse(result);
		    	var areaNameArray = new Array();
