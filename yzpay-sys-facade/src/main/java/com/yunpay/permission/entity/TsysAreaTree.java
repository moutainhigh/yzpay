...
public class TsysAreaTree {
	...
	private Set<TsysAreaTree> areaList = new HashSet(0);
	@SuppressWarnings("rawtypes")
	private List childArea = new ArrayList(0);
	
	public TsysAreaTree(TsysArea area){
	...
	public Set<TsysAreaTree> getAreaList() {
		return areaList;
	}
	public void setAreaList(Set<TsysAreaTree> areaList) {
