    ...
    */
    ...
    pwd.append(str[i]);
     ...
     public static void main(String[] args){
    	 String queryStr = "merchant_num=999910020002138546&pay_channel=wechat&terminal_unique_no=88:25:93:AB:D0:4F&user_order_no=20161212225229848&sign=e260bc83054800a6d769a894a35a8cd5&sign_type=MD5";
    	 Map<String,String> params = new HashMap<String,String>();
     	if(!StringUtils.isEmpty(queryStr)){
     		String[] arrays =  queryStr.split("&");
     		for(int i=0;i<arrays.length;i++){
    	 ...
    	 MD5Utils.verify(params, params.get("sign"), "b8rpaym1pmeazcn1xma6qqr8hyvpklhdds8y", "utf-8");
     }
