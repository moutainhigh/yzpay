	...
	function sumTrans(){
		...
		var url = allUrl+'/sys/reportContr/sumTrans?transTime='+transTime;
		$.ajax({
		    url:url,
		    type:'POST',
		    timeout:5000,   
	...
	function sumTransByDay(){
		var url = allUrl+'/sys/reportContr/sumTransByDay';
		$.ajax({
		    url:url,
		    type:'POST',
		    timeout:5000,   
	...
	function sumTransByWeek(){
		var url = allUrl+'/sys/reportContr/sumTransByWeek';
		$.ajax({
		    url:url,
		    type:'POST',
		    timeout:5000,   
	...
	function sumTransByMonth(){
		var url = allUrl+'/sys/reportContr/sumTransByMonth';
		$.ajax({
		    url:url,
		    type:'POST',
		    timeout:5000,   
	...
	function day_report(){
		$.ajax({
			type:"post", 
			url:allUrl+'/sys/reportContr/printReportByDay',
		    dataType: "json",
		    timeout:5000,   
		    success: function (result){
		    	var _data = new Array();
	...
	function week_report(){
		$.ajax({
			type:"post", 
			url:allUrl+'/sys/reportContr/printReportByWeek',
		    dataType: "json",
		    timeout:5000,   
		    async:false,  
		    cache:false,
	...
	function month_report(){
		$.ajax({
			type:"post", 
			url:allUrl+'/sys/reportContr/printReportByMonth',
		    dataType: "json",
		    timeout:5000,   
		    async:false,  
		    cache:false,
