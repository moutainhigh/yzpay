...
<form  method="post" action="${baseURL}/sys/merchContr/toUpdate?type=1">
...
<div class="classify_div">
			...
			<ul class="aui-list aui-form-list register-form">
				<li class="aui-list-item">
            		<div class="aui-list-item-inner">
                		...
                		<div class="aui-list-item-input" ><input type="text" value="${merch.registerName }" readonly="readonly" style="margin-left: 25px; color: #ADADAD;" /></div>
            		</div>
        		</li>
        		...
        		<li class="aui-list-item">
            		<div class="aui-list-item-inner">
                		...
                		<div class="aui-list-item-input"><input type="text" value="${merch.merchantName }" readonly="readonly" style="margin-left: 25px; color: #ADADAD;" /></div>
            		</div>
        		</li>
			...
			<ul class="aui-list aui-form-list register-form">
				<li class="aui-list-item">
            		<div class="aui-list-item-inner">
                		...
                		<div class="aui-list-item-input">
                			<input type="text" value="${merch.cardName }" readonly="readonly" style="margin-left: 25px; color: #ADADAD; " /> 
                		</div>
            		</div>
        		</li>
				...
				<li class="aui-list-item">
            		<div class="aui-list-item-inner">
                		...
                		<div class="aui-list-item-input">
                		<input type="text" value="${merch.cardNo }" readonly="readonly" style="margin-left: 25px; color: #ADADAD; " />
			...
			<ul class="aui-list aui-form-list register-form">
				...
				<li class="aui-list-item">
            		<div class="aui-list-item-inner ">
                		...
                		<div class="aui-list-item-input"><input type="text" value="${merch.tel }" readonly="readonly" style="margin-left: 25px; color: #ADADAD; "  />
                		</div>
            		</div>
        		</li>
			...
			<ul class="aui-list aui-list-in si-aui-list">
				<li class="aui-list-item">
            		<div class="aui-list-item-inner">
                		...
                		<div class="aui-list-item-input">
                		<input type="text" value="${merch.accBank }" readonly="readonly" style="margin-left: 25px; color: #ADADAD; "  />
    		...
    		<li class="aui-list-item">
				...
				<li class="aui-list-item">
            		<div class="aui-list-item-inner">
                		...
                		<div class="aui-list-item-input">
                		<input type="text" value="${merch.accSubBank }" readonly="readonly" style="margin-left: 25px; color: #ADADAD; "  />
				...
				<li class="aui-list-item">
            		<div class="aui-list-item-inner">
                		...
                		<div class="aui-list-item-input">
                		<input type="text" value="${merch.accName }" readonly="readonly" style="margin-left: 25px; color: #ADADAD; "  />
				...
				<li class="aui-list-item">
            		<div class="aui-list-item-inner">
                		...
                		<div class="aui-list-item-input">
                		<input type="text" value="${merch.accNo }" readonly="readonly" style="margin-left: 25px; color: #ADADAD; "  />
	...
	<div style="margin-left:14px; margin-bottom: 15px;" id="success_btn">
