        ...
        <li class="aui-list-item login-list-item">
            <div class="aui-list-item-inner">
                ...
                <div class="aui-list-item-input">
                    ...
                    <input type="password" autocomplete="off" id="pwd" name="pwd" placeholder="6-15位数字+字母" onfocus="changeType(this);" onblur="checkPwd(this)" onkeydown="removeInfo(this)" maxlength="15">
